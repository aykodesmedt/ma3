<section class="headerbeeld">
  <div>
    <p class="header_datum">24-26 AUG</p>
    <p class="header_editie">13e editie</p>
    <p class="header_gratis">GRATIS</p>
  </div>
  <h1 class="hidden">Internationaal Straattheaterfestival Beveren</h1>
  <img src="./assets/img/logo_groot_320.png" alt="logoGroot" width="274" height="115">
  <!-- <img src="" alt="maskers" /> -->
</section>
...
<section class="vrijwilligers">
  <h3 class="vrijwilliger_titel">Vrijwilliger</h3>
  <p class="vrijwilliger_uitleg">
  ...
  <a href=""><span class="alleButton">Voorwaarden<span></a>
</section>
<section>
      ...
      <div class="event_foto">
        ...
        <picture>
          ...
          ./assets/img/andere_evenementen/jpg/avondfeestmarkt@0,75x.jpg 280w"
            sizes="100vw" type="image/jpeg">
          <img class="img--full" src="./assets/img/andere_evenementen/jpg/avondfeestmarkt.jpg" alt="avondfeestmarkt" width="300" height="300">
        </picture>
      </div>
      ...
      <div class="event_foto">
        ...
        <picture>
          ...
          ./assets/img/andere_evenementen/jpg/rommelmarkt@0,75x.jpg 280w"
            sizes="100vw" type="image/jpeg">
          <img class="img--full" src="./assets/img/andere_evenementen/jpg/rommelmarkt.jpg" alt="rommelmarkt" width="300" height="300">
        </picture>
      </div>
