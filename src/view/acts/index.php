<section class="headerbeeld">
  ...
  <div class="headerbeeld--images">
    ...
    <img class="headerbeeld--image1 image--klein" src="./assets/img/logo_groot_320.png" alt="logoGroot" width="274" height="115">
    <img class="headerbeeld--image1 image--groot" src="./assets/img/logo_groot_1440.png" alt="logoGroot" width="717" height="299">
    <img class="headerbeeld--image2 image--groot" src="./assets/img/headerbeeld.png" alt="headerbeeld">
    <img class="headerbeeld--image2 image--klein" src="./assets/img/headerbeeld_320.png" alt="headerbeeld">
  </div>
</section>
...
<section class="section--isb-over">
  ...
  <p class="p--isb-uitleg">
    ...
    opgericht door Beveren Verbindt. Dit jaar vind de 13e editie van dit
    evenement plaats. Dankzij het succes van de vorige editie blijft de
    locatie van het evenement hetzelfde dit jaar. <br/> <br/>ISB zorgt voor humor,
    (lucht)acrobatie, vuuracts en stuntwerk van de bovenste plank. Deze
    acts worden uitgevoerd door groepen die uit wel 10 verschillende
    landen komen: België, Nederland, Duitsland, Frankrijk, Spanje, Italië,
